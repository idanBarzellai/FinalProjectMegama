...
public partial class @TestInputs: IInputActionCollection2, IDisposable
{
    ...
    ~@TestInputs()
    {
        UnityEngine.Debug.Assert(!m_CharctersControls.enabled, "This will cause a leak and performance issues, TestInputs.CharctersControls.Disable() has not been called.");
    }
    ...
    private List<ICharctersControlsActions> m_CharctersControlsActionsCallbackInterfaces = new List<ICharctersControlsActions>();
    ...
    public struct CharctersControlsActions
    {
        ...
        public void AddCallbacks(ICharctersControlsActions instance)
        {
            if (instance == null || m_Wrapper.m_CharctersControlsActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_CharctersControlsActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ICharctersControlsActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(ICharctersControlsActions instance)
        {
            if (m_Wrapper.m_CharctersControlsActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ICharctersControlsActions instance)
        {
            foreach (var item in m_Wrapper.m_CharctersControlsActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_CharctersControlsActionsCallbackInterfaces.Clear();
